...
/* Controllers */
  ...
  app.controller('AccordionDemoCtrl', ['$scope', '$http', function($scope, $http, instance) {
  ...
  app.controller('HeaderCtrl', ['$scope', function($scope) {
   ...
   //ngDialog
   app.controller('MainCtrl', function ($scope, $http, $rootScope, ngDialog, $timeout) {
       //$scope.oldPrincipalName = "a";
       ...
       $scope.openRename = function() {
        ...
        $scope.renamePrincipal = function(oldPrincipalName,newPrincipalName) {
          console.log('renamePrincipal' + oldPrincipalName + newPrincipalName);
